...
import { useStore, fmtEUR, fmtPct, OBJEKTTYP_LABEL } from "@/lib/store";
              ...
              >
                ...
                <dl className="mt-4 grid grid-cols-2 gap-x-3 gap-y-2 border-t pt-3 text-xs">
                  ...
                  <div>
                    ...
                    <dd className="font-medium">{k.bruttorendite != null ? fmtPct(k.bruttorendite) : "—"}</dd>
                  </div>
                  <div>
                    <dt className="text-muted-foreground">Kaltmiete/Mon.</dt>
                  ...
                  <div>
                    ...
                    <dd className={"font-medium " + (k.cashflowMonat >= 0 ? "text-blue-600" : "text-destructive")}>
                      {k.rateMonat > 0 || k.monatskaltmiete > 0 ? fmtEUR(k.cashflowMonat) : "—"}
                    </dd>
                  </div>
                </dl>
                </div>
